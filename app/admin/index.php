...
$count_kuenstler       = (int) db()->query("SELECT COUNT(*) FROM teilnehmer WHERE kategorie = 'kuenstler'")->fetchColumn();
$count_gruppen         = (int) db()->query("SELECT COUNT(*) FROM teilnehmer WHERE kategorie != 'kuenstler'")->fetchColumn();
